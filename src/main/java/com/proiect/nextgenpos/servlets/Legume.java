 ...
 */
package com.proiect.nextgenpos.servlets;

import com.proiect.nextgenpos.common.LegumeDetails;
import com.proiect.nextgenpos.ejb.LegumaBean;
 ...
 * @author adrian
 */
@WebServlet(name = "Legume", urlPatterns = {"/Legume"})
public class Legume extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Legume</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Legume at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
